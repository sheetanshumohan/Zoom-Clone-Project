...
export default function MeetingRoomPage() {
  ...
  const createPeerConnection = (peerId: string, ws: WebSocket) => {
    ...
    pc.oniceconnectionstatechange = () => {
      console.log(`WebRTC: ICE connection state for ${peerId} changed to: ${pc.iceConnectionState}`);
    };

    pc.onconnectionstatechange = () => {
      console.log(`WebRTC: Connection state for ${peerId} changed to: ${pc.connectionState}`);
    };
